...
* If you want to set-up e-mail sending create a __conf.json__ file bases on the __[conf.json.sample](https://github.com/zuzuleinen/bibi/blob/master/conf.json.sample) [MailGun](https://www.mailgun.com) is supported only.
