...
* If you want to set-up e-mail sending create a __conf.json__ file based on the [conf.json.sample](https://github.com/zuzuleinen/bibi/blob/master/conf.json.sample). MailGun is supported only.
